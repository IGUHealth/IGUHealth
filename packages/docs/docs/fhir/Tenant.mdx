# Tenant
 ...
 | Tenant.id | 0..1 | http://hl7.org/fhirpath/System.String | The logical id of the resource, as used in the URL for the resource. Once assigned, this value never changes. 
 | Tenant.meta | 0..1 | Meta | The metadata about the resource. This is content that is maintained by the infrastructure. Changes to the content might not always be associated with version changes to the resource. 
 | Tenant.name | 1..1 | string | undefined 
 | Tenant.description | 0..1 | string | undefined 
 ## Search Parameters 

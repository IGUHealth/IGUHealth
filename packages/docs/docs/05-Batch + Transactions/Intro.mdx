...
Our server supports submitting both batch and transaction [Bundles](../Resources/Bundle.mdx).
...
Submitting batch bundles (designated by batch on [Bundle.type](../Resources/Bundle.mdx)) allows you to submit sets of actions.

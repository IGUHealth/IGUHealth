...
Our server supports submitting both batch and transaction [Bundles](../Data_Model/R4/Bundle.mdx).
...
Submitting batch bundles (designated by batch on [Bundle.type](../Data_Model/R4/Bundle.mdx)) allows you to submit sets of actions.

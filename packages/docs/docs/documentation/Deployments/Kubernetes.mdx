...
```bash
docker run -p 3000:3000 --env REDIS_HOST=docker.for.mac.host.internal --env REDIS_PORT=6379 --env RESOURCE_STORAGE_NAME=testdb --env RESOURCE_STORAGE_PORT=5432 --env RESOURCE_STORAGE_USERNAME=postgres --env RESOURCE_STORAGE_HOST=docker.for.mac.host.internal ghcr.io/iguhealth/iguhealth/iguhealth server
```
...
```bash
docker run  --env REDIS_HOST=docker.for.mac.host.internal --env REDIS_PORT=6379 --env RESOURCE_STORAGE_NAME=testdb --env RESOURCE_STORAGE_PORT=5432 --env RESOURCE_STORAGE_USERNAME=postgres --env RESOURCE_STORAGE_HOST=docker.for.mac.host.internal ghcr.io/iguhealth/iguhealth/iguhealth worker
```
...
```bash
docker run --env RESOURCE_STORAGE_NAME=testdb --env RESOURCE_STORAGE_PORT=5432 --env RESOURCE_STORAGE_USERNAME=postgres --env RESOURCE_STORAGE_HOST=docker.for.mac.host.internal ghcr.io/iguhealth/iguhealth/iguhealth migrate
```
            ...
            - name: REDIS_PORT
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets
                  key: redis-port
            - name: RESOURCE_STORAGE_NAME
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets
                  key: fhir-db-name
            - name: RESOURCE_STORAGE_HOST
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets
                  key: fhir-db-host
            - name: RESOURCE_STORAGE_PORT
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets
                  key: fhir-db-port
            - name: RESOURCE_STORAGE_USERNAME
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets
                  key: fhir-db-username
            - name: RESOURCE_STORAGE_PASSWORD
              valueFrom:
                secretKeyRef:
                  name: iguhealth-secrets

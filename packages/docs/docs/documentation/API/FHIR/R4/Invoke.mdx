...
```bash
 curl --request GET --header "Authorization: Header" --header "Content-Type: application/fhir+json" ${domain}/w/${tenant}/api/v1/fhir/r4/$code --data $Parameters
```
  </TabItem>
...
```
  ...
  <TabItem value="curl" label="Curl">
```bash
 curl --request GET --header "Authorization: Header" --header "Content-Type: application/fhir+json" ${domain}/w/${tenant}/api/v1/fhir/r4/${ResourceType}/$code --data $Parameters
```
  </TabItem>
   <TabItem value="typescript" label="Typescript">
```typescript
...
```
  ...
  <TabItem value="curl" label="Curl">
```bash
 curl --request GET --header "Authorization: Header" --header "Content-Type: application/fhir+json" ${domain}/w/${tenant}/api/v1/fhir/r4/${ResourceType}/${ResourceId}/$code --data $Parameters
```
  </TabItem>
   <TabItem value="typescript" label="Typescript">
```typescript

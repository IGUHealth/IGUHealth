...
```typescript
await client.history_system({}, FHIRVersion, [{name: "_since-version", value: ["2550"]}]);
```
   </TabItem>
</Tabs>
...
```
   ...
   <TabItem value="typescript" label="Typescript">
```typescript
await client.history_type({}, FHIRVersion, resourceType, [{name: "_since-version", value: ["2550"]}]);
```
   </TabItem>
</Tabs>
...
```
   ...
   <TabItem value="typescript" label="Typescript">
```typescript
await client.history_instance({}, FHIRVersion, resourceType, id, [{name: "_since-version", value: ["2550"]}]);
```
   </TabItem>
</Tabs>

...
Our server supports submitting both batch and transaction [Bundles](../04-Resources/Bundle.mdx).
...
Submitting batch bundles (designated by batch on [Bundle.type](../04-Resources/Bundle.mdx)) allows you to submit sets of actions.

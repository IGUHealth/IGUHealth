...
function DemoForm() {
  ...
  const client = createHTTPClient({
    url: "https://api.iguhealth.app/w/2ld12f8nbrz80m3asevbk",
                ...
                <div className="flex flex-col p-4 col bg-gray-50 rounded-md shadow-lg items-center border border-solid space-y-4 border-gray-400">
                  <form className="w-full max-w-[500px] py-8 space-y-4">
                    ...
                    <div className="px-3">
                      <button
                        type="submit"
                        className="cursor-pointer mt-4 border border-solid border-blue-700 bg-blue-500 py-3 px-5 text-sm font-medium text-center text-white rounded hover:bg-blue-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300"
                      >
                        Book demo
                      </button>
                    </div>

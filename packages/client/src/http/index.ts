...
import { Versioned } from "../interface.js";
...
function httpMiddleware<CTX extends Versioned>(): MiddlewareAsync<
  HTTPClientState,
  CTX
> {
...
export default function createHTTPClient<CTX extends Versioned>(

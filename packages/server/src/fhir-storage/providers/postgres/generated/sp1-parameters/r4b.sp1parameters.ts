...
export const r4b_sp1_idx: Set<string> = new Set([
...
export type r4b_sp1_idx_token =
  | "resource_id"
  | "account_status"
  | "account_type"
  | "activitydefinition_status"
  | "activitydefinition_version"
  | "administrableproductdefinition_dose_form"
  ...
  | "location_status"
  | "manufactureditemdefinition_dose_form"
  | "measure_status"
  | "measure_version"
  ...
  | "medicinalproductdefinition_domain"
  | "medicinalproductdefinition_status"
  | "medicinalproductdefinition_type"
  ...
  | "packagedproductdefinition_name"
  | "packagedproductdefinition_status"
  | "patient_active"
  | "individual_gender"
  ...
  | "regulatedauthorization_case_type"
  | "regulatedauthorization_status"
  ...
  | "subscription_status"
  | "subscription_type"
  | "subscriptiontopic_status"
  | "subscriptiontopic_version"
  | "substance_status"
  | "substancedefinition_domain"
...
const r4b_sp1_idx_token_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/Resource-id",
  "http://hl7.org/fhir/SearchParameter/Account-status",
  "http://hl7.org/fhir/SearchParameter/Account-type",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-status",
...
export function asSP1Token(url: uri): r4b_sp1_idx_token | undefined {
  if (!r4b_sp1_idx_token_set.has(url)) return undefined;
  return sqlSafeIdentifier(url) as r4b_sp1_idx_token;
}

export type r4b_sp1_idx_date =
...
const r4b_sp1_idx_date_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/Resource-lastUpdated",
  "http://hl7.org/fhir/SearchParameter/Account-period",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-date",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-effective",
...
export function asSP1Date(url: uri): r4b_sp1_idx_date | undefined {
  if (!r4b_sp1_idx_date_set.has(url)) return undefined;
  return sqlSafeIdentifier(url) as r4b_sp1_idx_date;
}

export type r4b_sp1_idx_uri =
  | "resource_source"
  ...
  | "subscription_url"
  | "subscriptiontopic_url"
  | "testscript_url"
  | "valueset_expansion";

const r4b_sp1_idx_uri_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/Resource-source",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-url",
  "http://hl7.org/fhir/SearchParameter/conformance-url",
  "http://hl7.org/fhir/SearchParameter/ChargeItemDefinition-url",
...
export function asSP1Uri(url: uri): r4b_sp1_idx_uri | undefined {
  if (!r4b_sp1_idx_uri_set.has(url)) return undefined;
  return sqlSafeIdentifier(url) as r4b_sp1_idx_uri;
}

export type r4b_sp1_idx_string =
  | "account_name"
...
const r4b_sp1_idx_string_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/Account-name",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-description",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-name",
  "http://hl7.org/fhir/SearchParameter/ActivityDefinition-publisher",
...
const r4b_sp1_idx_number_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/ChargeItem-factor-override",
  "http://hl7.org/fhir/SearchParameter/MolecularSequence-window-end",
  "http://hl7.org/fhir/SearchParameter/MolecularSequence-window-start",
]);

export function asSP1Number(url: uri): r4b_sp1_idx_number | undefined {
  if (!r4b_sp1_idx_number_set.has(url)) return undefined;
  return sqlSafeIdentifier(url) as r4b_sp1_idx_number;
}

export type r4b_sp1_idx_quantity =
...
const r4b_sp1_idx_quantity_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/ChargeItem-price-override",
  "http://hl7.org/fhir/SearchParameter/ChargeItem-quantity",
  "http://hl7.org/fhir/SearchParameter/Condition-abatement-age",
  "http://hl7.org/fhir/SearchParameter/Condition-onset-age",
...
export function asSP1Quantity(url: uri): r4b_sp1_idx_quantity | undefined {
  if (!r4b_sp1_idx_quantity_set.has(url)) return undefined;
  return sqlSafeIdentifier(url) as r4b_sp1_idx_quantity;
}

...
export const r4_sp1_idx: Set<string> = new Set([
  ...
  "https://iguhealth.app/fhir/SearchParameter/Membership-link",
...
export type r4_sp1_idx_reference =
  ...
  | "medicinalproductauthorization_holder"
  | "medicinalproductauthorization_subject"
  ...
  | "membership_federated_identityprovider"
  | "membership_link"
  | "messagetopic_broker";

const r4_sp1_idx_reference_set: Set<string> = new Set([
  "http://hl7.org/fhir/SearchParameter/Account-owner",
  "http://hl7.org/fhir/SearchParameter/AdverseEvent-location",
  "http://hl7.org/fhir/SearchParameter/AdverseEvent-recorder",
  "http://hl7.org/fhir/SearchParameter/AdverseEvent-subject",

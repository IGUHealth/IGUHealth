...
CREATE INDEX idx_number_idx_rid on r4_number_idx using HASH (r_id);

DROP INDEX idx_uri_idx_rid;

CREATE INDEX idx_uri_idx_rid on r4_uri_idx using HASH (r_id);

DROP INDEX idx_quantity_idx_rid;

CREATE INDEX idx_quantity_idx_rid on r4_quantity_idx using HASH (r_id);

DROP INDEX idx_reference_idx_rid;

CREATE INDEX idx_reference_idx_rid on r4_reference_idx using HASH (r_id);

DROP INDEX idx_date_idx_rid;

CREATE INDEX idx_date_idx_rid on r4_date_idx using HASH (r_id);

DROP INDEX idx_token_idx_rid;

CREATE INDEX idx_token_idx_rid on r4_token_idx using HASH (r_id);

DROP INDEX idx_string_idx_rid;

CREATE INDEX idx_string_idx_rid on r4_string_idx using HASH (r_id);

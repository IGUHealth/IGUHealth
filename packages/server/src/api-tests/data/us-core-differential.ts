  ...
  snapshot: {
    element: [
      ...
      },
      {
        ...
        constraint: [
          ...
          },
          {
            ...
            severity: "error",
            human:
              "At least name.given and/or name.family are present or, if neither is available, the Data Absent Reason Extension is present.",
            expression:
              "(family.exists() or given.exists()) xor extension.where(url='http://hl7.org/fhir/StructureDefinition/data-absent-reason').exists()",
            xpath:
              "(/f:extension/@url='http://hl7.org/fhir/StructureDefinition/data-absent-reason' and not(/f:family or /f:given)) or (not(/f:extension/@url='http://hl7.org/fhir/StructureDefinition/data-absent-reason') and (/f:family or /f:given))",
          },
        ],
        mustSupport: true,
        isModifier: false,
      ...
      },
      {
        ...
        short:
          "(USCDI) usual | official | temp | nickname | anonymous | old | maiden",
      ...
      },
      {
        ...
        short:
          "(USCDI) Given names (not always 'first'). Includes middle names",
      ...
      },
      {
        ...
        short:
          "(USCDI) home | work | temp | old | mobile - purpose of this contact point",
      ...
      },
      {
        ...
        short:
          "(USCDI) home | work | temp | old | billing - purpose of this address",
      ...
      },
      {
        ...
        short:
          "(USCDI) A language which may be used to communicate with the patient about his or her health",
        definition:
      ...
      },
      {
        ...
        short:
          "(USCDI) The language which can be used to communicate with the patient about his or her health",
        definition:
